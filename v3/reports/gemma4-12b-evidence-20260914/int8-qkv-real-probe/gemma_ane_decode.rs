...
pub fn provision_static_cache_with_capacity(
    ...
    Ok(visit_static_cache(model_dir, part, capacity, false)?.len())
}
...
pub fn inspect_static_cache_with_capacity(
    ...
    visit_static_cache(model_dir, part, capacity, true)
}
    ...
    for index in 0..LAYERS {
        ...
        let result = match part {
            AneStaticCachePart::QueryKeyValue => {
                ...
                AneLinear::compile_with_cache_policy(&weights, HIDDEN, rows, 1, policy).map(drop)
            }
