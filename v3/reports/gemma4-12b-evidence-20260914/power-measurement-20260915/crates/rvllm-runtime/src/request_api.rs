...
/// Cloneable, bounded admission handle.
#[derive(Clone)]
        ...
        W: InferenceWorker,
    {
        ...
        thread::Builder::new()
            ...
            .spawn(move || {
                ...
                worker_loop(&mut worker, command_rx, control_rx);
            })
            .map_err(|error| {
...
fn run_request<W: InferenceWorker>(worker: &mut W, command: RequestCommand) {
    let RequestCommand {
        request_id,
        request,
        submitted_at,
