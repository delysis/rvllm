kernel void research_global_d512_split_coopkey_r8k8p64t128s32_partial(
    ...
    global_decode_split_partial_body<8, 0, 64, 128, 32, true>(q, k, v, partials, table,
        contexts, positions, p, group, tid, sg, lane, threads, qt, stage, scores,
        alpha, weight, pages);
}

kernel void research_global_d512_split_coopkey_r8k8p64t128s32_merge(
    ...
    uint3 threads [[threads_per_threadgroup]]) {
    global_decode_split_merge_body<32>(partials, output, table, contexts, positions, p,
