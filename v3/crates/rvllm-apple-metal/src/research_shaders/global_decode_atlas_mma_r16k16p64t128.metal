kernel void research_global_d512_atlas_mma_r16k16p64t128(
    ...
    threadgroup float qt[16 * 64], stage[16 * 64], scores[16 * 16], weights[16 * 16], state[3 * 16];
    threadgroup int pages[16];
    global_decode_matrix_body<16, 16, 64, 128>(q, k, v, output, table, contexts, positions, p,
