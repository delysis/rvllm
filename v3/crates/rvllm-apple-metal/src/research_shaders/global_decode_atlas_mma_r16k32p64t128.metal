kernel void research_global_d512_atlas_mma_r16k32p64t128(
    ...
    threadgroup float qt[16 * 64], stage[32 * 64], scores[16 * 32], weights[16 * 32], state[3 * 16];
    threadgroup int pages[32];
    global_decode_matrix_body<16, 32, 64, 128>(q, k, v, output, table, contexts, positions, p,
