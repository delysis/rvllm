...
def run_case(args: argparse.Namespace, case: ManifestCase, command: Sequence[str]) -> dict[str, Any]:
    ...
    return {
        ...
        "prepare_ms": report.get("prepare_ms"),
        "prefill_ms": report.get("prefill_ms"),
        "decode_ms": report.get("decode_ms"),
        "tok_per_s": report.get("tok_per_s"),
        "arena_bytes": report.get("arena_bytes"),
        "command_buffers": report.get("command_buffers"),
        "encoders": report.get("encoders"),
        "forced_waits": report.get("forced_waits"),
        "max_supported_total_tokens": report.get("max_supported_total_tokens"),
