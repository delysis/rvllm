...
| full residual parity | REAL-CORRECTNESS | `cpu_reference_one_layer_full_nonzero_residual_vector_is_stable`, `tiny_one_layer_full_nonzero_model_backend_full_residual_matches_cpu` | Yes, ignored Metal test | Synthetic one-layer fixture only | Broaden to real-shape synthetic fixtures |
