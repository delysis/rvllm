...
| optional real Gemma dry-run | REAL-CHECKPOINT-DRYRUN | `real_gemma4_model_dir_dry_run_validates_when_env_is_set` | No decode; optional model dir gate | Skips when `RVLLM_GEMMA4_MODEL_DIR` is unset | Run against real model dir and fix valid shape mismatches |
